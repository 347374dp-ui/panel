...
- **Realistic Device Templates:** Generates highly realistic device data for major brands: Google Pixel, Samsung Galaxy, Xiaomi, and OnePlus.
...
- **Direct Firebase Integration:** Automatically upload generated proto hex strings to your Firebase database (`/protos.json`) with a single command-line flag.
